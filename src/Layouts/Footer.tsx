  ...
  return (
    <footer className=" bg-blue-900 flex flex-col items-center justify-center pt-8 px-3 lg:pt-20">
      <div className=" flex flex-col md:flex-row-reverse  md:max-w-[83%] mx-auto gap-10 ">
        <div className="flex px-8 md:px-0 justify-between md:justify-around md:flex-1 max-sm:text-sm  text-white font-light md:gap-10 ">
        ...
        <div className=" px-4 mt-6 sm:mt-0 md:w-3/6 h-full ">
          <img
            src={meerasfooter}
