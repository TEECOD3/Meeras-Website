    ...
    return (
        <footer className=" bg-blue-900 flex flex-col items-center justify-center pt-8 px-3 lg:pt-20">
            <div className=" flex flex-col md:flex-row-reverse  md:max-w-[83%] mx-auto gap-10 ">
                <div className="flex justify-between md:justify-around md:flex-1 max-sm:text-sm  text-white font-light md:gap-10 ">
                    <ul className="space-y-8 text-md md:text-base">
                ...
                <div className="mt-8 sm:mt-0 md:w-3/6 h-full ">
                    <div className="bg-merrasfooter h-20 w-20 bg-no-repeat bg-contain "></div>
                    <p className="lg:w-2/3 mt-2 text-md sm:text-xl text-white font-light md:text-base">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Sed ornare cursus sed nunc eget dictum Sed ornare cursus
