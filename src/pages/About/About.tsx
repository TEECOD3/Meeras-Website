...
const About = () => {
  return (
    <main className="pt-20">
      <section className="  bg-white  p-1 lg:py-10 mb-14">
        <div className="w-full h-full relative mx-auto flex flex-col  lg:flex-row   sm:w-[80%] md:w-[70%]  md:mt-14  lg:mt-0 lg:w-[90%] lg:p-20 lg:gap-1 ">
          ...
          <div className="mt-10 h-[10rem] lg:mt-0 lg:absolute  lg:top-4  lg:w-[80%] right-[10rem] xxl:w-2/4 xl:h-[30rem] lg:h-[25rem] ">
