    ...
    <Reveal>
      <div className="overflow-hidden cursor-pointer ring ring-slate-100 mb-3 ">
        ...
        <div className="px-4 md:px-6 mb-4 py-6 lg:h-[200px]">
          <h3 className="text-base font-semibold uppercase mb-3 text-black  sm:text-xl   lg:text-xl xxl:text-4xl">
            {title}
          </h3>
          <p className="text-sm font-normal sm:text-sm lg:text-base tracking-tight line-clamp-5">
            {paragraph}
          </p>
        </div>
      </div>
